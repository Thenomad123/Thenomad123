...
<!---
Thenomad123/Thenomad123 to ✨ specjalne ✨ repozytorium, ponieważ jego `README.md` (ten plik) pojawia się na Twoim profilu GitHub.
Możesz kliknąć link Podgląd, aby zobaczyć swoje zmiany.
--->
import { createSlice, createAsyncThunk } from '@reduxjs/toolkit';
import axios from 'axios';

// Pobieranie aktywności GitHub
export const fetchGitHubData = createAsyncThunk('chatbotBłąd rozpoznawania mowy:", event.error);
  };
